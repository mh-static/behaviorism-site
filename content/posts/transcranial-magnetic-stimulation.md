...
<style><!--
table { 	border: 1px solid gray;     	border-collapse: collapse;      	width: 500px;   	cellspacing: 0; } th {     	background-color: #F5F5DC;          border: 1px solid black; }  th#blank {     	background- color: #FFF;  }  th.colOne {         width: 100px; } td {     	text-align: center;  	border: 1px solid black; } table#diagnosis th.data {         width: 120px; }
--></style>
...
Earlier in the abstract, however, they had said that the participants who benefitted from "…acute TMS treatment <i>were tapered from their TMS regimen</i>, consented to long-term follow up over 52 weeks, and were evaluated for statistical analysis."  [Emphasis added]
